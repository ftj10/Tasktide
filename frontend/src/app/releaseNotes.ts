...
export const RELEASE_NOTES: ReleaseNote[] = [
  ...
  },
  {
    ...
    releasedAt: "2026-05-06",
    title: {
      en: "Mobile Navigation and Design Refresh",
      zh: "移动端导航与界面焕新",
    },
    summary: {
      en: "TaskTide now has a cleaner flat design, better mobile spacing, and a bottom navigation bar that keeps every tab visible.",
      zh: "TaskTide 现在采用更清爽的扁平化设计，移动端间距更舒适，底部导航也能完整显示所有标签。",
    },
    changes: {
      en: [
        ...
        "Improved: Mobile pages and dialogs now use larger touch targets, full-screen forms, and safer spacing near the bottom navigation.",
        "Fixed: Bottom navigation tabs are no longer cut off on small mobile screens.",
      ],
      zh: [
        "新增：TaskTide 现在采用焕新的扁平化视觉设计，卡片更清爽，按钮更清晰，手机端更易阅读。",
        "新增：移动端帮助现在包含底部导航使用演示。",
        "改进：移动端页面和对话框现在使用更大的触控区域、全屏表单，并在底部导航附近保留更安全的间距。",
        "修复：小屏手机上的底部导航标签不再被截断。",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    title: {
      en: "Syllabus Import: Large Syllabi Now Extract Correctly",
      zh: "课程大纲导入：大型大纲现可正确提取",
    },
    summary: {
      en: "Automatic analysis no longer returns empty results for syllabi with many entries.",
      zh: "自动分析不再对包含大量条目的大纲返回空结果。",
    },
    changes: {
      en: [
      ...
      zh: [
        "修复：自动课程大纲分析现在可以可靠地提取所有课程事件，即使对于包含大量作业、讲座和周期性义务的大型大纲也不例外。",
      ],
    },
  },
  {
    id: "2026-05-05-syllabus-auto-draft-generation",
    version: "v2.7.2",
    releasedAt: "2026-05-05",
    title: {
      en: "Syllabus Import: Better Automatic Extraction",
      zh: "课程大纲导入：更好的自动提取"
    },
    summary: {
      en: "Analyze with Claude now uses the stronger draft-generation flow and looks for more kinds of coursework details.",
      zh: "“用 Claude 分析”现在使用更强的任务草稿生成流程，并会查找更多课程事项。"
    },
    changes: {
      en: [
        "Improved: Automatic syllabus import now looks for assignments, readings, prep work, recurring course obligations, and other academic planning items.",
      ...
      zh: [
        "改进：自动课程大纲导入现在会查找作业、阅读、准备工作、重复课程安排和其他学习规划事项。",
        "修复：“用 Claude 分析”现在使用更强的任务草稿生成流程，当课程大纲包含可用信息时更不容易导入为空。"
      ]
    }
  },
  {
    id: "2026-05-05-syllabus-auto-analysis-fix",
    version: "v2.7.1",
    releasedAt: "2026-05-05",
    title: {
      en: "Syllabus Import Analysis Fix",
      zh: "课程大纲导入分析修复"
    },
    summary: {
      en: "Automatic syllabus analysis now connects to Claude correctly when an API key is configured.",
      zh: "配置 API key 后，自动课程大纲分析现在可以正确连接 Claude。"
    },
    changes: {
      en: [
        "Fixed: Automatic syllabus analysis no longer fails from an invalid AI request when Claude generation is enabled."
      ],
      zh: [
        "修复：启用 Claude 生成后，自动课程大纲分析不再因无效 AI 请求而失败。"
      ]
    }
  },
  {
    id: "2026-05-05-syllabus-task-descriptions",
    version: "v2.7.0",
    releasedAt: "2026-05-05",
    title: {
      en: "Syllabus Import: Clearer Task Details",
      zh: "课程大纲导入：更清晰的任务详情"
    },
    summary: {
      en: "Syllabus imports now ask AI tools to include a short useful description for every generated task.",
      zh: "课程大纲导入现在会要求 AI 为每个生成任务提供简短有用的描述。"
    },
    changes: {
      en: [
        "Improved: Imported syllabus tasks now include clearer descriptions when generated by AI, so you can understand each task after it is added to your planner."
      ],
      zh: [
        "改进：通过 AI 生成的课程大纲任务现在会包含更清晰的描述，添加到计划后也更容易理解。"
      ]
    }
  },
  {
